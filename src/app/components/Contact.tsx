    ...
    <section className="py-20 bg-gradient-to-br from-[#1E3A8A] via-[#2563EB] to-[#1E3A8A] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            <div className="w-20 h-20 bg-[#F97316] rounded-full flex items-center justify-center shadow-2xl">
          ...
          <p className="text-xl text-[#F8FAFC]/90 max-w-2xl mx-auto">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-white/20 border border-white/30 rounded-xl text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-[#F97316] focus:border-transparent"
                ...
                <div>
                  ...
                  <div className="border-2 border-dashed border-white/30 rounded-xl p-6 text-center hover:border-[#F97316] transition-colors cursor-pointer bg-white/5">
                    <input
                      type="file"
                      accept="image/*"
                      className="hidden"
            ...
            <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-8 border border-white/20 shadow-2xl">
              ...
              <div className="space-y-4">
                ...
                <motion.a
                  ...
                  className="flex items-center gap-4 bg-[#25D366]/20 border border-[#25D366] rounded-2xl p-4 hover:bg-[#25D366]/30 transition-colors"
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                >
